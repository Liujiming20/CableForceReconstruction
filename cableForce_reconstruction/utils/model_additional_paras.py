...
def modified_paras_by_missing_fea_num(args, missing_fea_num):
    if args.model_option != "LSTNet":
        ...
        if missing_fea_num == 0:
            args.trained_model_root = "./trained_SMs/{}/".format(args.model_option)
        elif missing_fea_num == 1:
            args.trained_model_root = "./trained_SMs/partial_input/one_input_missing/"
        elif missing_fea_num == 2:
            args.trained_model_root = "./trained_SMs/partial_input/two_input_missing/"
        elif missing_fea_num == 3:
            args.trained_model_root = "./trained_SMs/partial_input/three_input_missing/"
        else:
            SystemExit("重构模式数目有异常，请核查程序！")
