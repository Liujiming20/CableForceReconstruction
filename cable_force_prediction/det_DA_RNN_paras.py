...
@software: PyCharm
@file: det_DA_RNN_paras.py
@time: 2024/10/30 21:30
"""
import time
...
def main():
    ...
    # hidden_size_encoder_list = [32,64,128,256]

    args.hidden_size_decoder = 256
    # hidden_size_decoder_list = [32,64,128,256]
    ...
    # for hidden_size_encoder_value in hidden_size_encoder_list:
    #     args.hidden_size_encoder = hidden_size_encoder_value
    #     print("执行hidden_size_encoder为{}的训练测试".format(str(hidden_size_encoder_value)))
    #
    #     for hidden_size_decoder_value in hidden_size_decoder_list:
    #         args.hidden_size_decoder = hidden_size_decoder_value
    #         print("执行hidden_size_decoder为{}的训练测试".format(str(hidden_size_decoder_value)))
    #         train_model(args, train_val_dataset)
