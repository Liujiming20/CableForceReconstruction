...
def define_paras():
    ...
    parser.add_argument('-trained_model_loss_value_root', type=str, default='./result/Loss_value/LSTNet/', help="模型损失值存储路径")
    parser.add_argument('-reconstruction_outcome_root', type=str, default='./result/reconstruction_result/LSTNet/', help="模型重构值存储路径")
...
def add_prediction_option(parser, prediction_option):
    ...
    print("此处执行的是{}拉索索力重构模型的训练".format(prediction_target))
